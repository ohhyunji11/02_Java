...
public class ClsService /* extends Student*/{
	...
	public void ex2() {
	 ...
	 System.out.println(std1.shcoolName);
	// schoolName에 노란줄이 뜨는 이유(경고) => 제대로 작성을 안해서
	
	// *** static이 붙은 필드(변수)는 '클래스명.변수명' 으로 사용함 ***
		 System.out.println(Student.shcoolName);
		 
		 Student.shcoolName = "kH정보교육원";
		 
		 
		 System.out.println(Student.shcoolName);
		 System.out.println(std1.shcoolName);
		 System.out.println(std2.shcoolName);
