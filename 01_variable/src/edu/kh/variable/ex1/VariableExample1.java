...
public class VariableExample1 {
	// 생성된 .java 파일과 class 오른쪽에 작성된 이름은 같아야 한다.
		...
		public static void main(String[] args) {
			...
			System.out.println(2 * 3.142593653589793 * 5);
			System.out.println(3.142593653589793 * 5 * 5);
			System.out.println(3.142593653589793 * 5 * 5 * 20);
			System.out.println(4 * 3.142592653589793 * 5 * 5);
