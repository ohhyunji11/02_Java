...
public class PolyService {
	...
	public void ex1() {
		...
		//Car car3 = new Spark(); 
		 ...
		 // 상속 + 다형성
		 // 상속 특징 : Car 상속 클래스는 모두 getEngine()을 가지고 있다면 정의
	...
	// 전달받은 Car 또는 자식객체(Tesla, Spark의 엔진, 바퀴갯수를 출력하는 메서드)
	...
	public void ex5() {
		...
		// 바인딩 (Biding)
		// 실제 실행할 메소드 코드와 호출하는 코들르 연결시키는것
		...
		// 참조변수 c2가 Car 타입이므로
		// toString()도 Car toString() 호출 - 정적바인딩
