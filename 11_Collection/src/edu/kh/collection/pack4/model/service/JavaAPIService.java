...
public class JavaAPIService {
	...
	public void method1() {
		...
		int num2 = wrap1; // 컴파일러가 Auto Unboxing 수행 코드 추가
						// (Integer) wrap1 -> (int) waap1에 저장된 값
		
		long num3 = 10_00_000_000L; // 100억
	...
	// 정수형, 실수형 공통
		...
		System.out.println("byte의 용량 : " + Byte.BYTES + "비트");
