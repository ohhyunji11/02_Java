...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// 배열 요소 값 대입
		// arr은 int[] 참조형 변수 이지만
		// arr[0], arr[1], arr[2] 이지만 int 자료형 변수이기 때문에 정수값을 대입할 수 있다!
		arr[0] = 10;
		arr[1] = 50;
		arr[2] = 100;
	...
	public void ex4() {
		...
		for(int i=0; i < score.length; i++) { // 최고점 비교
	...
	public void ex5() {
	   ...
	   // Array.toString(배열명) : 모든 요소 값을 출력
		
		System.out.print(Arrays.toString(arr) ); // [A,B,C,D,E]
		
		int[] arr2 = new int[4];
		System.out.print(Arrays.toString(arr2) ); // [0,0,0,0]
